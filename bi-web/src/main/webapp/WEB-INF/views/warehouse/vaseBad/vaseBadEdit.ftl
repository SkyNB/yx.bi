                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title text-left">
                            <i class="fa fa-pencil"></i> <span style="font-weight: bold">损坏品编辑</span>
                        </h4>
                    </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group not-error">
                                        <div class="form-group-item">
                                            <label class="control-label col-md-3">花瓶名称<span class="required"> * </span></label>
                                            <div class="col-md-3">
                                        ...
                                        <div class="form-group-item">
                                            <label class="control-label col-md-2">花瓶编号<span class="required"> * </span></label>
                                            <div class="col-md-3">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group not-error">
                                        <div class="form-group-item">
                                            <label class="control-label col-md-3">花瓶类型<span class="required"> * </span></label>
                                            <div class="col-md-3">
                                        ...
                                        <div class="form-group-item">
                                            <label class="control-label col-md-2">花瓶颜色<span class="required"> * </span></label>
                                            <div class="col-md-3">
