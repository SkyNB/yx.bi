                        ...
                        <form class="form-horizontal " action="" role="form" id="WareHousepaging">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <label class="col-md-2 control-label">花瓶名称</label>
                                    <div class="col-md-2">
                                        <input type="text" id="bT" name="batchTimes" value="" class="form-control">
                                    </div>
                                    <label class="col-md-2 control-label">花瓶颜色</label>
                                    <div class="col-md-2">
                                        <input type="text" id="bT" name="batchTimes" value="" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-1 control-label">进货时间</label>
                                    <div class="col-md-2">
                                        <input type="text" id="gname" name="goodsName" value="" class="form-control">
                                    </div>
                                    <label class="col-md-2 control-label">花瓶类型</label>
                                    <div class="col-md-2">
                                        <input type="text" id="bT" name="batchTimes" value="" class="form-control">
                                    </div>
                                </div>
