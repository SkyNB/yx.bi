                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group not-error">
                                        <div class="form-group-item">
                                            <label class="control-label col-md-3">清洗员<span class="required"> * </span></label>
                                            <div class="col-md-3">
                                        ...
                                        <div class="form-group-item">
                                            <label class="control-label col-md-2">清洗时间<span class="required"> * </span></label>
                                            <div class="col-md-3">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group not-error">
                                        <div class="form-group-item">
                                            <label class="control-label col-md-3">上次清洗时间<span class="required"> * </span></label>
                                            <div class="col-md-3">
                                        ...
                                        <div class="form-group-item">
                                            <label class="control-label col-md-2">清洗时间间隔<span class="required"> * </span></label>
                                            <div class="col-md-3">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group not-error">
                                        <div class="form-group-item">
                                            <label class="control-label col-md-3">清洗提示<span class="required"> * </span></label>
                                            <div class="col-md-3">
