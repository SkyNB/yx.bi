                        ...
                        <form class="form-horizontal " action="" role="form" id="WareHousepaging">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-1 control-label">花瓶名称</label>
                                    <div class="col-md-2">
                                        <input type="text" id="gname" name="goodsName" value="" class="form-control">
                                    </div>
                                    <label class="col-md-1 control-label">花瓶编号</label>
                                    <div class="col-md-2">
                                        <input type="text" id="gname" name="goodsName" value="" class="form-control">
                                    </div>
                                </div>
                                        ...
                                        <div class="btn-toolbar inline-block">
                                            <div class="btn-group">
                                                    <span class="caption-subject">
                                                        ...
                                                        <span class="ver-line">&nbsp;&nbsp;|&nbsp;</span>
                                                        <a onclick=""><span class="glyphicon glyphicon-trash"></span>&nbsp;查看</a>
                                                        <span class="ver-line">&nbsp;&nbsp;|&nbsp;</span>
                                                        <a onclick=""><span class="glyphicon glyphicon-trash"></span>&nbsp;删除</a>
                                                        <span class="ver-line">&nbsp;&nbsp;|&nbsp;</span>
                                                        <a onclick=""><span class="glyphicon glyphicon-trash"></span>&nbsp;上传</a>
                                                    </span>
                                            </div>
                                        </div>
                                    </td>
